...
def product_create(request, pk):
    ...
    if request.method == "POST":
        ...
        if product_form.is_valid():
            product_form.save()
            return HttpResponseRedirect(revers('admin:products', args=[pk]))
    else:
        product_form = ProductEditForm(initial={"category": category})

    content = {"title": title, "category": category,
               "product_form": product_form, "media_url": settings.MEDIA_ROOT}
...
def product_update(request, pk):
    ...
    if request.method == "POST":
        ...
        edit_form = ProductEditForm(isinstance=edit_product)
    content = {"title": title, "category": edit_product,
               "upadte_form": edit_form, "media_url": settings.MEDIA_URL}
...
def product_delete(request, pk):
    ...
    if request.method == "POST":
        ...
        product.save()
        return HttpResponseRedirect(reverse("admins:products", args=[products.category.pk]))
